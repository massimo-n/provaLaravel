 ...
 * Generated for Laravel 5.7.5 on 2018-09-25 09:47:59.
 *
...
namespace Illuminate\Support\Facades { 
     ...
     * @method static bool eventController(string $query, array $bindings = [])
    ...
    class DB {
        ...
        /**
         * Run an eventController statement against the database.
         *
         * @param string $query
         * @param array $bindings
         * @return bool 
